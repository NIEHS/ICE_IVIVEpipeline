...
EADplot <- EADboxplot(EAD.out = outputData,label="EAD", species = species, route = route, modelType = modelType)
```
<!-- # Saving the EAD plots -->
<!-- EAD box plots are generated within the model functions. This chunk saves the plot as a pdf. If a different file type is desired see [this cookbook on file outputs](http://www.cookbook-r.com/Graphs/Output_to_a_file/)  -->
<!-- ```{r} -->
<!-- pdf(EADplot_file) -->
<!-- EADplot -->
<!-- dev.off() -->
